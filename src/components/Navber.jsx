            ...
            <div className="navbar bg-base-100 container mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <NavLink to='/graph' className={({isActive})=>isActive ? 'text-accent font-bold bg-white border-2 border-green-300 rounded-md w-24 h-9 flex justify-center items-center ' : 'font-bold w-24 h-9 flex justify-center items-center'}>Graph Chart</NavLink>
